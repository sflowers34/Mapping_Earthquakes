...
//Retreive the earthquake GeoJason data. 
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
 //This function returns the style data for each earthquake we plot. We pass the magintude of the earthquake into a funct. to calc. the radius.
...
L.geoJson(data, {
    ...
    //Set the style for each cirlcemarker 
            style: styleInfo,
        }).addTo(map);
    });
